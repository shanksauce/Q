...
@property (strong, nonatomic, readonly) IBOutlet UILabel *peopleInFront;
@property (strong, nonatomic, readonly) IBOutlet UILabel *averageWaitTime;
@property (strong, nonatomic, readonly) IBOutlet UILabel *estimatedService;
@property (strong, nonatomic, readonly) IBOutlet UILabel *queueIdLabel;
